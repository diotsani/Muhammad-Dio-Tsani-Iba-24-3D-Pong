...
public class GameManager : MonoBehaviour
{
    ...
    //public List<GameObject> removePlayerList;
    ...
    void Start()
    {
        ...
        //foreach (GameObject playerTemp in GameObject.FindGameObjectsWithTag("Player"))
        //{
    ...
    {
        //for (int i = 0; i < removePlayerList.Count; i++)
        //{
            //playerList.Remove(removePlayerList[i]);
        //}
    }
